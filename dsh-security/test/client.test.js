...
test('renders the structured API inventory contract', () => {
  ...
  assert.match(source, /API_PAGE_SIZE = 20/)
  assert.match(source, /dsec-api-pagination/)
  ...
  assert.match(source, /dsec-report-content > \.dsec-finding/)
  assert.match(source, /margin-top:16px/)
